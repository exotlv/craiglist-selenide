package lv.sikhvart.cucumber.config;

import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.ENV;
            ...
            put("default", new Properties() {
                {
                    ...
                    //application URL's
                    setProperty(ApplicationProperty.APP_URL.name, "https://craiglist.com");

...
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.BROWSER;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.ENABLE_VIDEO;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.ENABLE_VNC;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.PROXY_ENABLED;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.PROXY_HOST;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.PROXY_PORT;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.REMOTE_DRIVER;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_RETRY_COUNT;
import static lv.sikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_URL;
...
import lv.sikhvart.cucumber.config.ApplicationProperties;
...
public class DriverFactory {
  ...
  private lv.sikhvart.cucumber.core.DriverType selectedDriverType;
  ...
  public DriverFactory() {
    lv.sikhvart.cucumber.core.DriverType driverType = DriverType.CHROME;
    String browser = ApplicationProperties.getString(BROWSER);
    try {
      driverType = lv.sikhvart.cucumber.core.DriverType.valueOf(browser.toUpperCase());
  ...
  private void instantiateWebDriver(lv.sikhvart.cucumber.core.DriverType driverType) {
    log.info(" ");
